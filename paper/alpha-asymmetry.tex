...
set. The weekly-return GPD shape parameter is imprecisely estimated ($\xi = -0.25$, 95\% CI $[-1.49, 0.27]$, an interval too wide to distinguish bounded from heavy tails), and tail clustering is weak ($\theta = 0.83$, 95\% CI $[0.60, 1.00]$). We conclude
